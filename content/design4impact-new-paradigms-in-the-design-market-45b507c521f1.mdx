...
<cite>Here's a piece that explores design from a socially responsible PoV.</cite>
</blockquote>

<Image
  src="/blog/images/2020/05/1_ctAEkT3cQimDyhY2ICmlHw-1.png"
  alt=""
  width={700}
  height={172}
/>
...
<figure className="wp-block-gallery columns-3 is-cropped"><ul className="blocks-gallery-grid"><li className="blocks-gallery-item"><Image
  src="/blog/images/2020/05/1_1_QtpAHfF7KUWK_dpWqgpw.png"
  alt=""
  width={276}
  height={182}
/></li><li className="blocks-gallery-item"><Image
  src="/blog/images/2020/05/1_6GHmQciBULOygDtQ3VbLug.png"
  alt=""
  width={276}
  height={151}
/></li><li className="blocks-gallery-item"><Image
  src="/blog/images/2020/05/1_35Cw8EVUn76wQszGuWp4dg.png"
  alt=""
  width={276}
  height={213}
/></li></ul><figcaption className="blocks-gallery-caption">How to be a creative agency in 2018? (3 steps, from L to R.)</figcaption></figure>
...
<figure className="wp-block-gallery columns-3 is-cropped"><ul className="blocks-gallery-grid"><li className="blocks-gallery-item"><Image
  src="/blog/images/2020/05/1_2GLalJHrTRRrzI3SmxVhSg.png"
  alt=""
  width={276}
  height={100}
/></li><li className="blocks-gallery-item"><Image
  src="/blog/images/2020/05/1_DXpacSY6SIoZ0aGnH6PWwA.png"
  alt=""
  width={387}
  height={381}
/></li><li className="blocks-gallery-item"><Image
  src="/blog/images/2020/05/1_bOSMpfF3CjjPExgJfMSuZA.png"
  alt=""
  width={276}
  height={130}
/></li></ul></figure>
