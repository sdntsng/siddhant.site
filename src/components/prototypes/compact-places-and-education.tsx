    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-6 border-t border-border/40 text-sm">
      ...
      <div className="space-y-3.5">
        ...
        <div className="space-y-3">
          {DATA.work.map((w: any) => (
            <div key={w.company} className="flex items-center justify-between gap-3 group">
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="flex items-baseline gap-1.5 min-w-0 truncate">
                  <Link
                    ...
                    className="font-medium text-foreground hover:underline inline-flex items-center gap-0.5 lowercase text-sm truncate"
                  >
                  ...
                  <span className="text-xs text-muted-foreground truncate">{w.title}</span>
                </div>
              </div>
          ...
          <div className="flex items-center justify-between gap-3 group">
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="flex items-baseline gap-1.5 min-w-0 truncate">
                ...
                <span className="text-muted-foreground/40 text-xs shrink-0">·</span>
                <span className="text-xs text-muted-foreground truncate">integrated programme</span>
              </div>
            </div>
            <span className="text-[11px] font-mono text-muted-foreground/70 shrink-0 tabular-nums">
              2015 — 2020
